...
***ПЕРЕДУМОВИ:***<br>
Користувач немає облікового запису<br>

***РЕЗУЛЬТАТ:***<br>
Необхідно створити обліковий запис користувача<br>

***ВИКЛЮЧНІ СИТУАЦІЇ:***<br>
EX.001.001 Адресу електроної почти не введено<br>
EX.001.002 Введено не коректний адрес електроної почти<br>
EX.001.003 Введено занадто короткий пароль<br>
EX.001.004 Пароль та пароль підтвердження не співпадають<br>
